...
- [ ] **Step 1: Replace the desktop-oriented shell with a mobile app mount point**
...
- [ ] **Step 2: Establish the approved mobile visual system**
...
- [ ] **Step 3: Update the README preview entry point**
...
- [ ] **Step 4: Manually inspect the bare shell in a browser**

Run the local HTTP server, open `http://127.0.0.1:4173`, and confirm there is no horizontal overflow at 390px width.
...
- [ ] **Step 1: Define three complete Southeast Asia source trips**
...
- [ ] **Step 2: Add filter and feed-selection state**
...
- [ ] **Step 3: Render one complete trip card**
...
- [ ] **Step 4: Add filter event handling and empty state**
...
- [ ] **Step 5: Manually verify filtering**

At the local preview, filter to Chiang Mai, then choose an impossible budget. Confirm the Chiang Mai card appears first and the reset action restores a card.
...
- [ ] **Step 1: Add pure skip and save state updates**
...
- [ ] **Step 2: Add explicit accessible buttons**
...
- [ ] **Step 3: Show short outcomes**

On skip, show “已跳过这趟旅行”; on save, show “已收藏这趟旅行”; on removal, show “已移出收藏”.

- [ ] **Step 4: Manually verify skip and save**

Save Bangkok, skip the current card, and confirm the next card is shown. Return to the discovery tab and confirm saved status remains until reload.
...
- [ ] **Step 1: Render original route information by day**
...
- [ ] **Step 2: Add a readable route map strip and controls**
...
- [ ] **Step 3: Keep source data read-only**
...
- [ ] **Step 4: Manually verify a complete route**

Open Bangkok’s detail from the feed and check that all source stops, costs, tips, attribution, Back, and Save are visible.

- [ ] **Step 5: Commit route detail**
...
- [ ] **Step 1: Implement a true deep-copy operation**
...
- [ ] **Step 3: Connect Copy actions**

The feed and detail primary action calls `copyTrip`, switches to the My itinerary tab, and shows “已复制到我的行程”.

- [ ] **Step 4: Manually verify isolation**

Copy Bangkok, open My itinerary, and confirm its source attribution, stop count, schedule, and budget display. Return to detail and confirm the original card remains unchanged.

- [ ] **Step 5: Commit copied itinerary**
...
- [ ] **Step 1: Implement guarded remix operations**
...
- [ ] **Step 2: Add edit controls to My itinerary**
...
- [ ] **Step 3: Recalculate derived information on every render**
...
- [ ] **Step 4: Manually verify Remix**

Copy a route, change one time, remove one stop, add one optional stop, and change the budget. Confirm the source detail does not change and the copied summary updates after each action.
...
- [ ] **Step 1: Render only saved source trips**
...
- [ ] **Step 2: Connect navigation and actions**
...
- [ ] **Step 3: Manually verify saved trips**

Save a trip in Discover, open 收藏, then open its detail and copy it. Confirm the saved source card remains in 收藏 and My itinerary opens with a copied route.

- [ ] **Step 4: Commit saved trips**
